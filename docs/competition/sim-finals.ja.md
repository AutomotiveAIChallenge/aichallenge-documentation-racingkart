...
- 9月18日 に、本番同様の環境で試走ができる 事前練習会 への参加が可能です。
- 両部門とも、参加を希望するチームはぜひご来場ください。特に、PCを持ち込むチームは接続・動作確認にご活用ください。
- 詳細・出欠は後日告知します。
...
※試合開始20分前までに、会場に用意したリハーサルテーブルにお集まりください
...
※試合開始20〜5分前までに、会場に用意した待機場所にお集まりください

※PCの搬入には練習走行時間、昼休みをご活用ください
...
| 時間（開始時刻基準） | 内容 |
| --- | --- |
| ①20分前 | リハーサルテーブルに集合。接続確認・動作確認を行う |
| ②5分前 | 待機場所に移動 |
| ③開始時刻 | ステージ上に移動 |
| ④0〜10分 | セットアップ |
| ⑤10〜18分 | 走行 |
...
- 開始時刻の20分前までに、メイン会場後方に用意したリハーサルテーブルにお集まりください。
    - リハーサルテーブルでは、試合と同じ構成のPCを用意しています。
    - リハーサルテーブルで、操作の最終確認を行えます。
- 開始時刻の5分前に、メイン会場前方の待機場所に移動します。
...
- 1回の試合は上記タイムテーブルに沿って行われます。
- 開始時刻の20〜5分前までに、メイン会場前方の待機場所にお集まりください。
- 開始時刻になったらステージ上に上がり、セットアップを始めます。
